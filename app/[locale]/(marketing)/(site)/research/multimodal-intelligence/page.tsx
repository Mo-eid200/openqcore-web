...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "research_multimodal_intelligence.seo",
  });
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: "https://openqcore.com/research/areas/multimodal-intelligence",
      siteName: "OpenQCore",
    },
    alternates: {
      canonical: "https://openqcore.com/research/areas/multimodal-intelligence",
      languages: {
        en: "https://openqcore.com/en/research/areas/multimodal-intelligence",
        ar: "https://openqcore.com/ar/research/areas/multimodal-intelligence",
      },
    },
  };
}
...
export default async function MultimodalIntelligencePage({
  params,
}: PageProps) {
  const { locale } = await params;
  const t = await getTranslations({
    locale,
    namespace: "research_multimodal_intelligence",
  });
  ...
  const engines = ["pulse_echo", "iris_orbit"] as const;
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {engines.map((k) => (
                  <span
                    key={k}
                    className="rounded-full border border-[#d4af37]/30 bg-[#d4af37]/10 px-3 py-1 text-xs font-semibold text-[#f3d98a]"
                  >
                    {t(`page.engines.${k}`)}
                  </span>
                ))}
            ...
            <div className="lg:col-span-5">
              <div className="relative ms-auto w-full max-w-[560px]">
                ...
                <div className="relative rounded-[26px] border border-white/[0.08] bg-[#0b1222]/85 p-2.5 shadow-[0_20px_70px_rgba(0,0,0,0.28)]">
                  <ImageWithLightbox
                    src="/engines/openqcore-multimodal-intelligence-promo.png"
                    alt="OpenQCore Multimodal Intelligence"
                    width={1400}
                    height={1000}
