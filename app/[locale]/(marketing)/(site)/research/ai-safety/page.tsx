...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "research_ai_safety.seo",
  });
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: "https://openqcore.com/research/areas/ai-safety",
      siteName: "OpenQCore",
    },
    alternates: {
      canonical: "https://openqcore.com/research/areas/ai-safety",
      languages: {
        en: "https://openqcore.com/en/research/areas/ai-safety",
        ar: "https://openqcore.com/ar/research/areas/ai-safety",
      },
    },
  };
}
...
export default async function AISafetyPage({
  ...
  const engines = ["iris_verify", "iris_guard"] as const;
            ...
            <div className="lg:col-span-5">
              <div className="relative ms-auto w-full max-w-[560px]">
                ...
                <div className="relative overflow-hidden rounded-[26px] border border-white/[0.08] bg-[#0b1222]/85 shadow-[0_20px_70px_rgba(0,0,0,0.28)]">
                  <ImageWithLightbox
                    src="/engines/openqcore-ai-safety-promo.png"
                    alt="OpenQCore AI Safety"
                    width={1400}
                    height={1000}
                    className="group block w-full"
                    imageClassName="h-auto w-full object-contain transition duration-500 group-hover:scale-[1.02]"
                  />
                </div>
              </div>
            </div>
