...
// ✅ Shared payment-brand marks — simplified geometric recreations
// (not the official brand asset files) used the way any checkout
// page nominatively displays accepted payment methods. Swap for the
// real Visa/Mastercard/Amex/PayPal/Apple Pay/Google Pay logo files
// whenever available.
